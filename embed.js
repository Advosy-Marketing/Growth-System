...
(function () {
  ...
  css.textContent =
    ...
    "background:linear-gradient(135deg,#8b5cf6,#a78bfa);color:#fff;border:0;border-radius:999px;padding:12px 18px;" +
    "font:600 14px/1 Inter,system-ui,sans-serif;cursor:pointer;box-shadow:0 8px 26px rgba(139,92,246,.45);transition:.18s}" +
